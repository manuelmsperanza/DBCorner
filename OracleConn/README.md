...
mvn archetype:generate -DarchetypeCatalog=http://repo.maven.apache.org/maven2/archetype-catalog.xml -Dfilter=maven-archetype-quickstart -DgroupId=net.dtdns.hoffnungland -DartifactId=OracleConn -Dpackage=net.dtdns.hoffnungland.db.corner.oracleconn -Dversion=0.0.1-SNAPSHOT
#Build settings
